...
class recode(Unit):
    ...
    def __init__(
        self,
        decode: Param[str | None, Arg.String(metavar='decode-as',
            help='Input encoding; Guess encoding by default.')] = None,
        encode: Param[str | None, Arg.String(metavar='encode-as',
            help='Output encoding; The default is {default}.')] = Unit.codec,
        errors: Param[str | None, Arg.Option('-E', metavar='handler', choices=Handler, help=(
            'Specify an error handler for both encoding and decoding. '
            'The possible choices are the following: {choices}'))] = None,
        decerr: Param[str | None, Arg.Option('-d', metavar='handler', choices=Handler,
            help='Specify an error handler for decoding.')] = None,
        encerr: Param[str | None, Arg.Option('-e', metavar='handler', choices=Handler,
