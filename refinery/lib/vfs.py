...
class VirtualFile:
    ...
    def __init__(self, fs: VirtualFileSystem, data: Optional[Binary] = None, extension: Optional[str] = None):
...
class VirtualFileSystem:
    ...
    def new(self, data: Optional[Binary] = None, extension: Optional[str] = None):
